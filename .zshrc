...
plugins=(autojump copybuffer copyfile dirhistory git jsontools sudo web-search zsh-autosuggestions zsh-syntax-highlighting)
...
export k9s="$HOME/git/k9s/execs/k9s"
...
alias devops='cd $HOME/Workspace/school/S8/Network_Infrastructure/DevOps/devops'
alias workspace='cd $HOME/Workspace/'
alias dots='cd $HOME/git/dots'
